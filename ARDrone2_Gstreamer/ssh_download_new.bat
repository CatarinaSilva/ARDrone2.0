...
echo killall -9 program.elf.respawner.sh; killall -9 program.elf; killall -9 gst-launch-0.10; killall -9 %EXE_NAME%; exit > generated_cmds_del.txt
...
echo cd /bin ; ./basescript.sh ; cd /update; chmod 777 video_script.sh; ./video_script.sh; chmod 777 %EXE_NAME%; ./%EXE_NAME% -w; killall -9 gst-launch-0.10 > generated_cmds.txt
