...
void video1InitGrabSend(int * workPort, int port)
{
#ifndef MATLAB_MEX_FILE
	...
	vid1.seq=0;
	vid1.trigger=0;
	if(vid1.n_buffers==0) vid1.n_buffers=8;
...
void video2InitGrabSend(int * workPort, int port)
{
#ifndef MATLAB_MEX_FILE
	...
	vid2.seq=0;
	vid2.trigger=0;
	if(vid2.n_buffers==0) vid2.n_buffers=8;
...
void video_GrabImage2(vid_struct *vid, img_struct *img) 
{
